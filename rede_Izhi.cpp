...
void runsim(double W, double g, double seed) {
	...
	int net_size = 8000;				/* Number of neurons of the network*/
	...
	double ext_input = 0.0;//-40;	/* External input*/
	int ind = 0;			/* Index for the buffer of synaptic inputs considering time delays*/
	
	double tpeak, tpast, vaux, t;	//auxiliar variables for the linear interpolation to detect spikes
